...
def main():
    ...
    serviceGeneric = GenericRepository[Veterinaria](Veterinaria, db)
        ...
        if opcion == "1":
            while True:
                ...
                if opcion == "1":
                    ...
                    student = serviceGeneric.create(nombre=vete.nombre)
                    print(f"Veterinaria creada: id={vete.id_veterinaria}, nombre={vete.nombre}")


                elif opcion == "2":
                    #veterinaria = servicio.ver_veterinarias()
                    veterinaria = serviceGeneric.getAll()
                    mostrar_veterinaria(veterinaria)

                elif opcion == "3":
                    Id = int(input("Ingrese el ID de la veterinaria a consultar: "))
                    #veterinaria = servicio.buscar_veterinaria(Id)
                    veterinaria = serviceGeneric.get(Id)
                    if veterinaria:
                    ...
                    if veterinaria:
                        ...
                        serviceGeneric.update(id_vete, veterinaria_actualizada)
                    ...
                    if veterinaria:
                        ...
                        serviceGeneric.delete(veterinariaId)
